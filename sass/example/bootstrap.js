...
Ext.Loader.addClassPathMappings({
  "BO": "../../app",
  "BO.lib.components.remoteCombobox": "../../app/lib/components/remoteComboBox.js",
  "BO.lib.components.searchWindow": "../../app/lib/components/searchButton.js",
  "BO.lib.components.uploadWindow": "../../app/lib/components/uploadButton.js",
  "BO.model.Photo": "../../app/model/Project.js",
  "BO.view.myviewport": "../../app/view/MyViewport.js",
  "Ext": "../../ext/src",
  ...
  "Ext.locale.es.Component": "../../ext/packages/ext-locale/overrides/es/ext-locale-es.js",
  "Ext.locale.es.form.CheckboxGroup": "../../ext/packages/ext-locale/overrides/es/ext-locale-es.js",
  "Ext.locale.es.form.RadioGroup": "../../ext/packages/ext-locale/overrides/es/ext-locale-es.js",
  "Ext.locale.es.form.field.Base": "../../ext/packages/ext-locale/overrides/es/ext-locale-es.js",
  "Ext.locale.es.form.field.ComboBox": "../../ext/packages/ext-locale/overrides/es/ext-locale-es.js",
  "Ext.locale.es.form.field.Date": "../../ext/packages/ext-locale/overrides/es/ext-locale-es.js",
  "Ext.locale.es.form.field.File": "../../ext/packages/ext-locale/overrides/es/ext-locale-es.js",
  "Ext.locale.es.form.field.HtmlEditor": "../../ext/packages/ext-locale/overrides/es/ext-locale-es.js",
  "Ext.locale.es.form.field.Number": "../../ext/packages/ext-locale/overrides/es/ext-locale-es.js",
  "Ext.locale.es.form.field.Text": "../../ext/packages/ext-locale/overrides/es/ext-locale-es.js",
  "Ext.locale.es.form.field.Time": "../../ext/packages/ext-locale/overrides/es/ext-locale-es.js",
  "Ext.locale.es.form.field.VTypes": "../../ext/packages/ext-locale/overrides/es/ext-locale-es.js",
  "Ext.locale.es.grid.GroupingFeature": "../../ext/packages/ext-locale/overrides/es/ext-locale-es.js",
  "Ext.locale.es.grid.PropertyColumnModel": "../../ext/packages/ext-locale/overrides/es/ext-locale-es.js",
  "Ext.locale.es.grid.header.Container": "../../ext/packages/ext-locale/overrides/es/ext-locale-es.js",
  "Ext.locale.es.grid.plugin.DragDrop": "../../ext/packages/ext-locale/overrides/es/ext-locale-es.js",
  "Ext.locale.es.picker.Date": "../../ext/packages/ext-locale/overrides/es/ext-locale-es.js",
  "Ext.locale.es.picker.Month": "../../ext/packages/ext-locale/overrides/es/ext-locale-es.js",
  "Ext.locale.es.toolbar.Paging": "../../ext/packages/ext-locale/overrides/es/ext-locale-es.js",
  "Ext.locale.es.view.AbstractView": "../../ext/packages/ext-locale/overrides/es/ext-locale-es.js",
  "Ext.locale.es.view.View": "../../ext/packages/ext-locale/overrides/es/ext-locale-es.js",
  "Ext.locale.es.window.MessageBox": "../../ext/packages/ext-locale/overrides/es/ext-locale-es.js",
...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "BO.controller.Role": [],
  "BO.controller.User": [],
  "BO.controller.Viewport": [],
  "BO.lib.ajaxHandler": [],
  "BO.lib.commonFunctions": [],
  "BO.lib.components.CKeditor": [],
  "BO.lib.components.crudGrid": [],
  "BO.lib.components.remoteCombobox": [],
  "BO.lib.components.searchButton": [],
  "BO.lib.components.searchWindow": [],
  "BO.lib.components.uploadButton": [],
  "BO.lib.components.uploadCustomButton": [],
  "BO.lib.components.uploadWindow": [],
  "BO.lib.overrides": [],
  "BO.model.Article": [],
  "BO.model.Category": [],
  "BO.model.Perm": [],
  ...
  "BO.store.Default": [],
  "BO.view.Viewport": [],
  "BO.view.article.Edit": [],
  "BO.view.article.List": [],
  "BO.view.category.Edit": [],
  "BO.view.category.List": [],
  "BO.view.myviewport": [],
  "BO.view.project.Edit": [],
  "BO.view.project.List": [],
  "BO.view.role.Edit": [],
  "BO.view.role.List": [],
  "BO.view.user.Edit": [],
  "BO.view.user.List": [],
  ...
  "Ext.locale.es.form.field.VTypes": [],
  ...
  "Ext.locale.es.window.MessageBox": [],
  "Ext.menu.CheckItem": [],
...
Ext.Loader.loadScriptsSync([
  ...
  "../../ext/packages/ext-locale/overrides/es/ext-locale-es.js",
